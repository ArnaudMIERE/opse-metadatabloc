<i18n  >
{
  "en": {
       ...
       "opseConvert": "Generate Thumbnails",
       "opseDelete": "Delete",
  ...
  "fr": {
      ...
      "opseConvert": "Générer des vignettes",
...
export default {
    name: "opse-generate-thumbnails-block",
    data() {
        return{
        files: [],
        datasetFile: null,
  ...
  methods: {
    ...
    this.deletionDialog = true
      ...
      this.axios({
        method: "get",
        url: this.url + "/dataFiles?collection="+this.metadata.id+"&folder="+index,
      }).then(response => {
          if (response){
